...
const updateRentalStatus = catchAsync( async(req: Request, res: Response)=>{
    ...
    const result = await landlordServices.updateRentalStatus(rentalReqId as string, landlordId, isActive, payload)
...
const getMyProperties =  catchAsync( async(req: Request, res: Response)=>{
    ...
    const result = await landlordServices.getMyProperties(landlordId as string, isActive);
